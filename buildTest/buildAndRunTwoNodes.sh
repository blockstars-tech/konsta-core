...
# cd ./data-dir && rm -rf ./blockchain && rm -rf ./trie && rm -rf ./consensus/metadata ./consensus/snapshots && cd ..

rm -Rf ./buildTest/konsta-non-signer/data-dir && rm -Rf ./buildTest/konsta-signer/konsta-signer
rm -Rf ./buildTest/konsta-signer/data-dir && rm -Rf ./buildTest/konsta-non-signer/konsta-non-signer 
...
#  ./konsta-non-signer server   --data-dir ./data-dir --chain genesis.json  --libp2p 0.0.0.0:1478  --grpc-address 0.0.0.0:9632  --jsonrpc 0.0.0.0:854 --seal 


# && ./konsta server   --data-dir ./data-dir --chain genesis.json  --libp2p 0.0.0.0:1478  --grpc-address 0.0.0.0:9632  --jsonrpc 0.0.0.0:854 --seal --sealAndSign 
